...
void Panorama::Init(const PanoramaConfiguration& configuration,
...
Vector2d Panorama::Project(const Vector3d& xyz) const {
...
Vector3d Panorama::Unproject(const Vector2d& uv, const double distance) const {
...
void Panorama::InitDepthMesh(const string& filename, const double phi_range) {
  ifstream ifstr;
